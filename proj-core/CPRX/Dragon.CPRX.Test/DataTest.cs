...
namespace Dragon.CPRX.Test
{
    ...
    public class DataTestCommand : CPRCommand<DataTestCommand>
    {
        ...
        public override IEnumerable<ICPRProjectionBase<DataTestCommand>> Projections
        {

            get
            {
                yield return CPRAutoProjection<DataTestCommand, DataTable>.Instance<CPRAutoProjection<DataTestCommand, DataTable>>();
            }
        }
    }
