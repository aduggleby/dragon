...
namespace Dragon.SecurityServer.AccountSTS.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> RemoveLogin(string loginProvider, string providerKey)
        {
            ...
            var routeValues = RequestHelper.ToRouteValues(Request.QueryString);
            routeValues.Add("Message", message);
            return RedirectToAction("ManageLogins", routeValues);
        }
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var routeValues = RequestHelper.ToRouteValues(Request.QueryString);
                routeValues["Message"] = ManageMessageId.ChangePasswordSuccess;
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            var routeValues = RequestHelper.ReturnUrlToRouteValues(Request.QueryString);
            if (result.Succeeded)
            {
                return RedirectToAction("ManageLogins", routeValues);
            }
            routeValues.Add("Message", ManageMessageId.Error);
            return RedirectToAction("ManageLogins", routeValues);
        }
