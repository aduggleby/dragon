...
namespace Dragon.Mail.Utils
{
    ...
    /// Source (adapted): http://www.codeproject.com/Articles/38959/A-Faster-Directory-Enumerator
    /// </summary>
    [Serializable]
    public class FileData
    {
        ...
        /// Initializes a new instance of the <see cref="FileData"/> class.
        /// </summary>
        /// <param name="fi">FileInfo that this
        /// object wraps.</param>
        internal FileData(FileInfo fi)
        {
            this.Attributes = fi.Attributes;

            this.CreationTimeUtc = fi.CreationTimeUtc;

            this.LastAccessTimeUtc = fi.LastAccessTimeUtc;
