...
namespace Dapper
{
     ...
     public  static partial class SqlMapperExtensions
    {
        ...
        public static T Get<T>(this IDbConnection connection, dynamic id, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            {
                s_selectQueries[type.TypeHandle] = sql = SqlBuilderHelper.BuildSelect(metadata, values, ref parameters);
            }
            else
            {
        ...
        public static IEnumerable<T> GetAll<T>(this IDbConnection connection, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            {
                var metadata = MetadataFor(type);
                s_selectAllQueries[type.TypeHandle] = sql = SqlBuilderHelper.BuildSelect(metadata);
            }
            ...
            bool letDbGenerateKey = false) where T : class
        {
            ...
            {
                s_insertQueries[type.TypeHandle] = sql = SqlBuilderHelper.BuildInsert(metadata, withoutKeys: letDbGenerateKey);
            }
        ...
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            {
                s_updateQueries[type.TypeHandle] = sql = SqlBuilderHelper.BuildUpdate(metadata);
            }
        ...
        public static bool Delete<T>(this IDbConnection connection, T entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            {
                s_deleteQueries[type.TypeHandle] = sql = SqlBuilderHelper.BuildDelete(metadata);
            }
        ...
        public static bool Exists<T>(this IDbConnection connection, T entity, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            {
                s_existsQueries[type.TypeHandle] = sql = SqlBuilderHelper.BuildDelete(metadata);
            }
